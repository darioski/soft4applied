...
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(15, 10), gridspec_kw={'height_ratios':[0.7, 0.3]})
...
ax1.legend(loc=(0.9, 0.72), frameon=False)
...
ax2.legend(loc=(0.9, 0.72), frameon=False)

time_text_kleft = ax2.text(0.4, 0.85, 'P(k<0)={:2.4f}'.format(0), transform=ax2.transAxes)
